#!/usr/bin/env python3
"""
Build script for Careverse HQ frontend
...
def build():
    ...
    try:
        print("=" * 60)
        print("Building Careverse HQ frontend...")
        print("=" * 60)
...
def extract_asset_hashes():
    ...
    try:
        ...
        manifest_path = "../careverse_hq/public/admin-central/.vite/manifest.json"
...
def update_html_template(js_file, css_file):
    ...
    try:
        import re
        dest_html = "../careverse_hq/www/admin-central.html"
        ...
        if css_file:
            old_css_pattern = r'<link rel="stylesheet" crossorigin href="/assets/careverse_hq/admin-central/assets/[^"]+\.css">'
            new_css_link = f'<link rel="stylesheet" crossorigin href="/assets/careverse_hq/admin-central/assets/{css_file}">'
        ...
        if js_file:
            old_js_pattern = r'<script type="module" crossorigin src="/assets/careverse_hq/admin-central/assets/[^"]+\.js"></script>'
            new_js_script = f'<script type="module" crossorigin src="/assets/careverse_hq/admin-central/assets/{js_file}"></script>'
